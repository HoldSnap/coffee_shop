...
<template>
  <aside class="main__sidebar sidebar">
    <ul class="sidebar__list">
      <li class="sidebar__item logo__block">
        <svg
          fill="#704232"
          version="1.1"
          id="Layer_1"
      ...
      <li class="sidebar__item svg__block">
        <svg
          class="sidebar__svg"
          viewBox="0 0 24 24"
          fill="none"
